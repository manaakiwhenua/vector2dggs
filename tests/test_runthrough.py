...
class TestH3(TestRunthrough):
    ...
    def test_h3_run(self):
        try:
            h3([TEST_FILE_PATH, str(TEST_OUTPUT_PATH), "-r", "8"], standalone_mode = False)
...
class TestRHP(TestRunthrough):
    ...
    def test_rhp_run(self):
        try:
            rhp([TEST_FILE_PATH, str(TEST_OUTPUT_PATH), "-r", "8"], standalone_mode = False)
...
class TestS2(TestRunthrough):
    ...
    def test_s2_run(self):
        try:
            s2([TEST_FILE_PATH, str(TEST_OUTPUT_PATH), "-r", "13"], standalone_mode = False)
